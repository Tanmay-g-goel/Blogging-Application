...
public class PostServiceImpl implements PostService {
	...
	@Autowired
	private ModelMapper mpdelMapper;
	...
	public PostDto createPost(PostDto postDto, Integer userId, Integer categoryId) {
		...
		Post post = this.mpdelMapper.map(postDto, Post.class);
		...
		return this.mpdelMapper.map(newPost, PostDto.class);
	}
	...
	public PostDto updatePost(PostDto postDto, Integer postId) {
		...
		return this.mpdelMapper.map(updatedPost, PostDto.class);
	}
	...
	public PostResponse getAllPost(Integer pageNumber, Integer pageSize, String sortBy, String sortDir) {
		...
		List<PostDto> postDtos = allPosts.stream()
				.map((post)-> this.mpdelMapper.map(post, PostDto.class)).collect(Collectors.toList());
	...
	public PostDto getPostById(Integer postId) {
		...
		return this.mpdelMapper.map(post, PostDto.class);
	}
	...
	public List<PostDto> getPostByCategory(Integer categoryId) {
		...
		List<PostDto> postDtos = posts.stream().map((post)-> this.mpdelMapper.map(post, PostDto.class)).collect(Collectors.toList());
		return postDtos;
	}

	@Override
	public List<PostDto> getPostByUser(Integer userId) {
		User us = this.userRepo.findById(userId)
				.orElseThrow(()-> new ResourceNotFoundException("User", "user id", userId));
